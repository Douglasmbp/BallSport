        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1><?php echo $_SESSION['equipos']->nombre ?></h1>
                        ...
                        <tbody>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <h6 class="collapse-header">Seleccione el Call</h6>
                                    <a class="collapse-item" href="index.php?mostrar=A">Call A</a>
                                    <a class="collapse-item" href="index.php?mostrar=C">Call C</a>
                                    <a class="collapse-item" href="index.php?mostrar=D">Call D</a>
                                    <a class="collapse-item" href="index.php?mostrar=H">Call H</a>
                                </div>
                            </div>
