<?php
session_start();
if ($_SESSION['user_data']->tipo_usuario != "estandar") {
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-image: linear-gradient(#000 50%, #ffff00);" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="estadisticas/index.php" aria-expanded="true" aria-controls="collapseTwo">
                ...
                <div class="container-fluid row">
                    <form action="" method="post">
                        ...
                        <div class="d-flex gap-4 align-items-end">
                            ...
                            <div>
                                <label class="form-label mx-4">Cantidad de jugadores:</label>
                                <input type="text" class="form-control mx-4" name="cedula">
                            </div>
                            <div>

                                <input type="submit" name="registrar" class="btn btn-primary mx-5" value="INSCRIBIR">
                            </div>
                    </form>
                </div>
            </div>
